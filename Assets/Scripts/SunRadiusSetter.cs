...
public class SunRadiusSetter : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        sunRadiuses[1].transform.position = new Vector3(sunRadiuses[1].transform.position.x, sunRadiuses[1].transform.position.y, ((11 * 2) + sunAmount) + (sun.transform.position.z - 33f));
        ...
        sunRadiuses[2].transform.position = new Vector3(sunRadiuses[2].transform.position.x, sunRadiuses[2].transform.position.y, ((13 * 2) + sunAmount) + (sun.transform.position.z - 39f));
    }
}
